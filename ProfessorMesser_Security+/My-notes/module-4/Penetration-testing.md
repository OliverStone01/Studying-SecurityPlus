...
The attack will start with the initial exploit then they will use lateral movement to jump to another machine or to an account with better privileges. From there we may want to create a backdoor in the system in case someone tries to patch the vulnerability we found. From there we pivot round and gain access to other parts of the organisation. 
